#ifndef SQUIRRELPLANNINGEXECUTION_PDDLACTIONS_CHARGEBATTERYPDDLACTION_H
#define SQUIRRELPLANNINGEXECUTION_PDDLACTIONS_CHARGEBATTERYPDDLACTION_H
...
public:
	 ...
	 */
	ChargeBatteryPDDLAction(ros::NodeHandle& node_handle);
	
	/**
	 * Destructor
	 */
	~ChargeBatteryPDDLAction();
